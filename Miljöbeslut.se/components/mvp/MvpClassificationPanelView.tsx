...
import type { Classification, Project } from './mvpDemoModel';
import { Badge, Card } from './mvpDemoShared';

type MvpClassificationPanelViewProps = {
  project: Project;
};

const MvpClassificationPanelView: React.FC<MvpClassificationPanelViewProps> = ({ project }) => {
  ...
  const runClassification = async () => {
    setLoading(true);
    try {
      const response = await callMvp<Classification>('/api/v1/classification', {
        method: 'POST',
...
export default MvpClassificationPanelView;
